...
@section('content')
    ...
    <div class="form-container">
        ...
        <br>
        <form action="{{ route('demandes-logements.update', $demande->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="col-6">
                ...
                <input type="text" name="lieu" id="lieu" class="form-control"
                    value="{{ old('lieu', $demande->lieu) }}" required>
            </div>
            ...
            <div class="col-12">
                ...
                <textarea name="description_electricite" id="description_electricite" class="form-control" rows="2">{{ old('description_electricite', $demande->description_electricite) }}</textarea>
            </div>

            <div class="col-12">
                <label for="description_eau" class="form-label">Description eau</label>
                <textarea name="description_eau" id="description_eau" class="form-control" rows="2">{{ old('description_eau', $demande->description_eau) }}</textarea>
            </div>
            ...
            <div class="col-6">
                ...
                <input type="number" name="nombre_chambres" id="nombre_chambres" class="form-control"
                    value="{{ old('nombre_chambres', $demande->nombre_chambres) }}" min="1" required>
            </div>

            <div class="col-6">
                <label for="autres_criteres" class="form-label">Autres critères</label>
                <textarea name="autres_criteres" id="autres_criteres" class="form-control" rows="2">{{ old('autres_criteres', $demande->autres_criteres) }}</textarea>
            </div>
