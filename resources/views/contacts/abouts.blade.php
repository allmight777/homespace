        ...
        <div class="row justify-content-center">
          <div class="col-lg-10">
            ...
            <div class="hero-content text-center" data-aos="zoom-in" data-aos-delay="200">
              ...
              <p class="hero-description">Depuis plus de 2 ans, nous mettons notre expertise au service des étudiants et jeunes actifs pour leur offrir des logements de qualité, adaptés à leurs besoins et à leur budget.</p>
            </div>
              ...
              <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                  <div class="primary-image-wrap">
                    <img src="{{ asset('images/image_13.webp') }}" alt="Propriété de luxe" class="img-fluid">
                ...
                <div class="col-lg-6">
                  <div class="secondary-image-wrap">
                    <img src="{{ asset('images/image_14.webp') }}" alt="Agent professionnel" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="feature-box" data-aos="flip-up" data-aos-delay="400">
                ...
                <div class="feature-content">
                  ...
                  <p>Nous proposons un large choix de logements adaptés à la vie étudiante et aux besoins des jeunes actifs.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="feature-box" data-aos="flip-up" data-aos-delay="450">
                ...
                <div class="feature-content">
                  ...
                  <p>Notre expertise s’étend également à la gestion et à la location de locaux commerciaux.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="feature-box" data-aos="flip-up" data-aos-delay="500">
                ...
                <div class="feature-content">
                  ...
                  <p>Nous accompagnons nos clients dans leurs projets d’investissement immobilier pour maximiser leur rentabilité.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
